...
int crypto_sign_signature2(uint8_t* sig, size_t* siglen,
    const uint8_t* m, size_t mlen,
    const uint8_t* sk);
...
int crypto_sign_verify2(const uint8_t* sig, size_t siglen,
    const uint8_t* m, size_t mlen,
    const uint8_t* pk);
...
int crypto_sign_open2(uint8_t* m, size_t* mlen,
    const uint8_t* sm, size_t smlen,
    const uint8_t* pk);
